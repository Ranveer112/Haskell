...
example2 = lines >.> map intVal >.> map (+1) >.> map show >.> unlines
...
example5 = lines >.> map intVal >.> scanl1' (+) 0 >.> map show >.> unlines

oneStep :: Int -> (Int,Int) -> (Int,Int)

oneStep val (n,total) = (n+1,total+val)

example6 = lines >.> map intVal >.> 
	   scanl1' oneStep (0,0) >.> 
	   map show >.> unlines

--------------------------------------------------------------------------
--	Converting strings to integers					--
--	This function replaces the read used in Haskell.		--
--------------------------------------------------------------------------

intVal :: String -> Int

intVal [] = 0
intVal (a:x) = digVal a * 10^(length x) + intVal x

digVal :: Char -> Int

digVal ch = ord ch - ord '0'
